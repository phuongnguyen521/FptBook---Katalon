...
WebUI.setText(findTestObject('FptBook_Product_Cart_Repo/Page_Home  FptBookStore/input_Quantity_AddToCartInput.Count'), '4')
...
WebUI.takeElementScreenshotAsCheckpoint('report_Product_Cart', findTestObject('FptBook_Product_Cart_Repo/Page_Home  FptBookStore/product_Cart'))
